          ...
          <section className="mb-28">
            <div className="max-w-3xl mx-auto">
              <a
                ...
                className="group relative block overflow-hidden rounded-3xl border border-white/10 bg-gray-900 transition-all hover:border-pink-500/30 hover:shadow-2xl hover:shadow-pink-500/10 hover:-translate-y-1"
              >
                ...
                <div className="relative -mt-16 px-8 pb-8">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <span className="text-sm text-zinc-600">{latestPost.date}</span>
